    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 8:
                ...
                _d.sent();
                res.json({
                    product: (0, utils_1.cleanResponseData)(decoratedProduct, req.allowedProperties || []),
                });
                return [2 /*return*/];
        }
    });
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!product) {
                        throw new utils_2.MedusaError(utils_2.MedusaError.Types.NOT_FOUND, "Product with id: ".concat(id, " not found"));
                    }
