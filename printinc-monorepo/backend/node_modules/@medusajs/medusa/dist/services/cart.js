                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 9:
                                            ...
                                            if ((0, medusa_core_utils_1.isDefined)(calculated_price)) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 3:
                                            ...
                                            if (!hasInventory) {
                                                throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_ALLOWED, "Inventory doesn't cover the desired quantity", medusa_core_utils_1.MedusaError.Codes.INSUFFICIENT_INVENTORY);
                                            }
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    ...
                                    case 4:
                                        ...
                                        return [3 /*break*/, 7];
                                    case 5:
                                        if (!(0, medusa_core_utils_1.isDefined)(data.email)) return [3 /*break*/, 7];
                                        return [4 /*yield*/, this.createOrFetchGuestCustomerFromEmail_(data.email)];
                                    case 6:
                                        customer = _g.sent();
                                        ...
                                        _g.label = 7;
                                    case 7:
                                        if (!((0, medusa_core_utils_1.isDefined)(data.customer_id) || (0, medusa_core_utils_1.isDefined)(data.region_id))) return [3 /*break*/, 9];
                                        return [4 /*yield*/, this.updateUnitPrices_(cart, data.region_id, data.customer_id)];
                                    case 8:
                                        _g.sent();
                                        _g.label = 9;
                                    case 9:
                                        if (!((0, medusa_core_utils_1.isDefined)(data.region_id) && cart.region_id !== data.region_id)) return [3 /*break*/, 11];
                                    ...
                                    case 23:
                                        if (!((0, medusa_core_utils_1.isDefined)(data.discounts) && !data.discounts.length)) return [3 /*break*/, 25];
                                        cart.discounts.length = 0;
                                        return [4 /*yield*/, this.refreshAdjustments_(cart)];
                                    case 24:
                                        _g.sent();
