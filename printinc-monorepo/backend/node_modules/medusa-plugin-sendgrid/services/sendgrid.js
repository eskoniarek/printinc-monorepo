          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 3:
                ...
                _context16.next = 6;
                return this.swapService_.retrieve(id, {
                  relations: ["additional_items", "additional_items.variant.product", "additional_items.tax_lines", "return_order", "return_order.items", "return_order.items.item", "return_order.shipping_method", "return_order.shipping_method.shipping_option"]
                });
              ...
              case 10:
                ...
                return this.orderService_.retrieve(swap.order_id, {
                  select: ["total"],
                  relations: ["items", "items.variant", "items.variant.product", "items.tax_lines", "discounts", "discounts.rule", "shipping_address", "swaps", "swaps.additional_items", "swaps.additional_items.tax_lines", "swaps.additional_items.variant"]
                });
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                ...
                _context20.next = 3;
                return this.swapService_.retrieve(id, {
                  relations: ["shipping_address", "shipping_methods", "shipping_methods.shipping_option", "shipping_methods.tax_lines", "additional_items", "additional_items.variant", "additional_items.variant.product", "additional_items.tax_lines", "return_order", "return_order.items"]
                });
              ...
              case 3:
                ...
                _context20.next = 6;
                return this.orderService_.retrieve(swap.order_id, {
                  relations: ["region", "items", "items.tax_lines", "items.variant", "items.variant.product", "discounts", "discounts.rule", "swaps", "swaps.additional_items", "swaps.additional_items.variant", "swaps.additional_items.variant.product", "swaps.additional_items.tax_lines"]
                });
            ...
            switch (_context21.prev = _context21.next) {
              case 0:
                ...
                return this.claimService_.retrieve(id, {
                  relations: ["order", "order.items", "order.items.variant", "order.items.variant.product", "order.shipping_address"]
                });
