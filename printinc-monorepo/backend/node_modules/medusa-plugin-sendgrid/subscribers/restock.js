...
var RestockNotification = /*#__PURE__*/_createClass(function RestockNotification(_ref) {
  var eventBusService = _ref.eventBusService,
      sendgridService = _ref.sendgridService;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return sendgridService.getTemplateId("restock-notification.restocked");
            ...
            case 5:
              _context2.next = 7;
              return sendgridService.fetchData("restock-notification.restocked", eventData, null);
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 3;
                          return sendgridService.sendEmail(sendOptions);
